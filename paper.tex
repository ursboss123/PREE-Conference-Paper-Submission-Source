...
\author{
\IEEEauthorblockN{Rahul Rajeevkumar Urs and Abdelrahman E.E. Eltoukhy}
\IEEEauthorblockA{
Department of Management Science and Engineering \\ Khalifa University\\
Abu Dhabi, United Arab Emirates\\
rahul.urs@ku.ac.ae, abdelrahamn.eltoukhy@ku.ac.ae}
}
...
The baseline comparison in Fig.~\ref{fig:comparison} is therefore a resilience and emissions trade-off rather than a conventional least-cost expansion result. PV, electrolyser, fuel-cell and tank capacity are under-utilised during ordinary grid-connected operation, but they provide a specific reliability function during long islanded events. The 44.5\% CO$_2$ reduction is achieved without assuming diesel removal: existing diesel capacity remains available outside the Monte Carlo sample, while sampled design-basis events are served by PV and stored hydrogen.
